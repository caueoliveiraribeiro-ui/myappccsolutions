...
export function BillingReminders({clients=[],tasks=[],editTask,currency="USD",ready=true}:Row){
 ...
 return <Card className="border border-red-400/70 bg-gradient-to-br from-red-500/[.09] to-black/20 p-5 text-white shadow-[0_0_25px_rgba(248,113,113,.16)]">
 <h2 className="font-semibold text-red-200">Upcoming client payments</h2>
 ...
 {recurring.length===0?<p className="mt-4 text-sm text-slate-400">Set a recurring billing frequency and charge date in Clients to see the next payments here.</p>:<div className="mt-4 space-y-3">{recurring.map((c:Row)=>{
